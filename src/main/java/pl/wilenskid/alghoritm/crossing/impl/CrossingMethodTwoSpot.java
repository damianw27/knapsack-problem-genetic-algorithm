...
public class CrossingMethodTwoSpot extends BaseCrossingMethod {

    public CrossingMethodTwoSpot() {
        super();
    }
    ...
    public List<Knapsack> getResult(List<Knapsack> ableToCross,
        ...
        knapsackPairs
                .forEach(pair -> Collections.addAll(result, cross(pair.getFirst(), pair.getSecond(), rnd.nextInt(bitsInElement), rnd.nextInt(bitsInElement))));
